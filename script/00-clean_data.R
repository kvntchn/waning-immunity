...
# Merge data
covid19.dat <- merge(cases.dat[area_type == 'County',.(
	date, county = area, cases, deaths,
	positive_tests, reported_tests)],
...
san_francisco.dat[, cases := zoo::rollmean(cases, 10, na.pad = T, align = 'center')]
